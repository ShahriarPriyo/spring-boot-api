...
import com.springapi.JWTConfiguration.JWTRequestFilter;
...
public class StoryControllerTest {
    ...
    public void setup(){
        mockMvc= MockMvcBuilders
                .webAppContextSetup(webApplicationContext).addFilter(jwtRequestFilter, "/*").build();
    }

    @Test
    @DisplayName("GET Find one story - Found")
    void testGetStorySuccess() throws Exception{
        StoryDTO mockstoryDto = new StoryDTO(1,"hello 01", "hjashalallkdaldlnadd", "priyo98@gmail.com");
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/stories/search/{id}",1))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.authorEmail").value("priyo98@gmail.com"));
    }
    ...
    void testGetStoryNotFound() throws Exception{
        StoryDTO mockstoryDto = new StoryDTO(1,"hello 01", "hjashalallkdaldlnadd", "priyo98@gmail.com");
        when(storyService.getStory(3)).thenReturn(mockstoryDto);
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/stories/search/{id}",1))
                .andExpect(status().isOk());
    }
    ...
    void testGetUserEmailAllStory() throws Exception{
        ...
        StoryDTO mockstoryDto2 = new StoryDTO(2,"hello 02", "hjashalallkdaldlnadd", "priyo98@gmail.com");
//        when(storyService.getAllStories(mockstoryDto1.getAuthorEmail())).thenReturn(Arrays.asList(mockstoryDto1, mockstoryDto2));
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/stories/{email}","priyo98@gmail.com"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE));
    }
